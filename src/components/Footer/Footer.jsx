...
export default function Footer() {
    return (
        <footer className="border-y border-white/10 bg-[#071326]/70 backdrop-blur-md">
            <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <a
                            href="https://discord.com/invite/AaTaHPt8Se"
                            className="text-gray-400 hover:text-gray-100"
                            target="_blank"
                            rel="noreferrer"
                        >
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 20 16"
                            >
                                <path d="M19.615 3.184a2.486 2.486 0 0 0-1.75-1.757C16.33 1 10 1 10 1s-6.33 0-7.865.427a2.486 2.486 0 0 0-1.75 1.757A25.022 25.022 0 0 0 0 8.5a25.022 25.022 0 0 0 .385 5.316 2.486 2.486 0 0 0 1.75 1.757C3.67 16 10 16 10 16s6.33 0 7.865-.427a2.486 2.486 0 0 0 1.75-1.757A25.022 25.022 0 0 0 20 8.5a25.022 25.022 0 0 0-.385-5.316ZM8 12.202V4.798L13.2 8.5Z" />
                            </svg>
